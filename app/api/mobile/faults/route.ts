...
import { createNativeFaultReport, nativeFaultSchema } from '../../../../services/native-workflow.service';
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const faultReportId = createNativeFaultReport(db, { orgId: user.orgId, actorUserId: user.id, payload: parsed.data });
